...
<?php
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$pop3=new pop3_class;
	$pop3->hostname="mail.noveltysoft.com";             /* POP 3 server host name                      */
	$pop3->port=110;                         /* POP 3 server host port,
	                                            usually 110 but some servers use other ports
	                                            Gmail uses 995                              */
	$pop3->tls=0;                            /* Establish secure connections using TLS      */
	$user="affan.usmani@novltysoft.com";                        /* Authentication user name                    */
	$password="123465";                    /* Authentication password                     */
