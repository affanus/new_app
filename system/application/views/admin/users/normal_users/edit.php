	...
	$("#email").live("focusout",function(e){
		...
		request.done(function( msg ) {
		  	if(msg.trim()==1){
				...
				$('.form-control-feedback').addClass('glyphicon-ok').removeClass('glyphicon-remove').show();
				$('#email-error-va').hide();	
			}else {
				email_validation=0;
				$('#email-error-va').html('Email Address Already Exists').show();	
				$('.form-control-feedback').addClass('glyphicon-remove').removeClass('glyphicon-ok').show();
				...
				<div class="card">
					...
					<div class="card-body floating-label ">
						<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
							<form class="form floating-label form-validation" role="form" novalidate="novalidate" action="<?= base_url().'admin/'.$controler_name.'/edit_action/'.$row->id;?>" method="post" enctype="multipart/form-data">
								<div class="form-wizard-nav">
									<div class="progress"><div class="progress-bar progress-bar-primary"></div></div>
									<ul class="nav nav-justified">
										<li class="active"><a href="#step1" data-toggle="tab"><span class="step">1</span> <span class="title">ACCOUNT INFO</span></a></li>
										<li><a href="#step2" data-toggle="tab"><span class="step">2</span> <span class="title">PERSONAL INFO</span></a></li>
										<li><a href="#step3" data-toggle="tab"><span class="step">3</span> <span class="title">COMPANY INFO</span></a></li>
										<li><a href="#step4" data-toggle="tab"><span class="step">4</span> <span class="title">CONTACT INFO</span></a></li>
									</ul>
								...
								<div class="tab-content clearfix">
										...
										<div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group has-feedback">
                                                    <input type="email" name="email" id="email" class="form-control" data-rule-email="true" required disabled="disabled" value="<?= stripslashes($row->email)?>">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
												<div class="form-group">
													<input type="password" name="password1" id="password1" class="form-control"  data-rule-minlength="5">
													<label for="password1" class="control-label">Password</label>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													<input type="password" name="passwordrepeat" id="passwordrepeat" class="form-control" data-rule-equalto="#password1">
									...
									<div class="tab-pane" id="step2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                            	<div class="col-sm-3">
                                                <img class="img-circle width-1" src="<?=base_url()?>/_images/profile_images/thumb/<?=stripslashes($row->profile_pic)?>" alt="">
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="form-group">
								...
								<ul class="pager wizard">
                                    ...
                                    <li class="submit"><button type="submit" class="btn ink-reaction btn-primary style-accent" disabled="disabled" id="submit_button">Submit</button></li>
								</ul>
							</form>
						</div>
