...
echo form_open('admin/newsletters/bulk_actions/', $attributes);?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="22%" align="right" style="padding-right:20px;"><a href="<?php echo base_url();?>admin/newsletters/add/<?= $this->uri->segment(4);?>"><img src="<?php echo base_url();?>img/admin/plus.png" align="absmiddle"/> Add Newsletter</a></td>
  </tr>
</table>
...
//echo $this->pagination->create_links();
  ...
  <tr>
    ...
    <td width="51%" class="grid_row"><a href="<?php echo base_url();?>admin/newsletters/edit/<?= $row->id;?>" class="show-tooltip" title="<strong>EDIT</strong><br><?= $row->title;?>"><b><?= $row->title;?></b></a></td>
    <td width="24%" class="grid_row">
    ...
    <td width="20%" class="grid_row"><a href="<?php echo base_url();?>admin/newsletters/del/<?= $row->id;?>" style="font-size:10px;" onclick="return confirm('Are You Sure To Delete?')" class="show-tooltip" title="<strong>DELETE</strong><br><?= $row->title;?>">DELETE</a></td>
  </tr>
  <? 
  $c++;
  endforeach;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
 ...
 if ($curpage > 1) {  ?>
	      <a href='<?php echo base_url();?>admin/newsletters/page/1' class="pagclass">&lt;&lt;</a>
	      <? 

    // get previous page num  
$prevpage = $curpage - 1;
    ?>
	      <a href='<?php echo base_url();?>admin/newsletters/page/<? echo $prevpage; ?>' class="pagclass">&lt;</a>
	      <?  
   ...
   // if it's a valid page number...  
    ...
    if (($x > 0) && ($x <= $tpages)) {  
     ...
     // if not current page...  
	      ...
	      <a href='<?php echo base_url();?>admin/newsletters/page/<? echo $x; ?>/' class="pagclass"><? echo $x; ?></a>
	      <?  
...
// echo forward link for next page  ?>
	      <a href='<?php echo base_url();?>admin/newsletters/page/<?= $nextpage;?>' class="pagclass">&gt;</a> <a href='<?php echo base_url();?>admin/newsletters/page/<?= $tpages;?>' class="pagclass">&gt;&gt;</a>
	      <?
