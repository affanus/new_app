...
echo form_open('admin/newsletters/edit_/'.$this->uri->segment(4), $attributes);?>
...
<? } ?>
  ...
  <tr>
    <td width="35%"><span class="formtxt upcl">Title</span><br />
      ...
      <input type="text" name="title" id="title" class="txtfield" onkeypress="if (event.keyCode == 13) {document.form.submit();}" value="<?= $row->title?>" style="width:300px;"/></td>
  ...
  <tr>
    <td colspan="2"><div style="width:97%;"><?=$this->ckeditor->editor("editor1",$row->content);?></div></td>
  </tr>
   <tr>
     <td colspan="2">&nbsp;</td>
   </tr>
