...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="78%"><div id="settings_heading">
	 <?
	$row = $query->row(); 	
	?>
	<?= $title?><?= $row->MessageType?></div></td>
    </tr>
</table>
<? 
$attributes = array('id' => 'form','name' => 'form');
echo form_open('admin/canned_emails/edit_/'.$this->uri->segment(4), $attributes);?>
...
<? } ?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="35%"><span class="formtxt upcl">Message Type</span><br />
      
      <input type="text" name="MessageType" id="MessageType" class="txtfield" onkeypress="if (event.keyCode == 13) {document.form.submit();}" value="<?= $row->MessageType?>" style="width:300px;"/></td>
    <td width="65%"><span class="formtxt upcl">Isactive</span><br />
  ...
  <tr>
    <td style="padding-top:5px;"><span class="formtxt upcl">mail Subject</span><br />
      <input type="text" name="mailsubject" id="mailsubject" class="txtfield" onkeypress="if (event.keyCode == 13) {document.form.submit();}" value="<?= $row->mailsubject?>" style="width:300px;"/></td>
    <td style="padding-top:5px;"><span class="formtxt upcl">mail email</span><br />
      <input type="text" name="mailemail" id="mailemail" class="txtfield" onkeypress="if (event.keyCode == 13) {document.form.submit();}" value="<?= $row->mailemail?>" style="width:300px;"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2"><div style="width:97%;"><?=$this->ckeditor->editor("editor1",$row->MessageContents);?></div></td>
  </tr>
   <tr>
     <td colspan="2">&nbsp;</td>
   </tr>
