                        	...
                        	<div class="col-lg-12">
                            	<div class="form-group">
                            		...
                            		<select class="form-control select2-list"  multiple required id="air_cat" name="air_cat[]">
                                    	...
                                    	<option value="<?=$air_cat->id?>" <? if(searchForId($air_cat->id, $man_cat)):?> selected="selected"<? endif;?>><?= stripslashes($air_cat->title);?></option>
                                        <? print_r($man_cat);	?>
                                        	<? endforeach; ?>
                                        <? endif; ?>
														
									</select>
									<label for="air_cat">Aircraft category </label>
                                </div>
                            </div>
                        </div>
