				...
				<div class="card">
                        	...
                        	<div class="col-lg-6">
                        		<div class="form-group">
                            		<select class="form-control select2-list"  required id="type_id" name="type_id">
                                    	...
                                    	<option value="<?=$row->id?>"><?= stripslashes($row->man_title);?> <?= stripslashes($row->title);?></option>
                                        	<? endforeach; ?>
                                        <? endif; ?>
														
									</select>
									<label for="type_id">Aircraft Type </label>
                                </div>
                            </div>    
							<div class="col-lg-6">
								<div class="form-group">
					...
					<div class="card-actionbar">
						<div class="card-actionbar-row">
							<button type="submit" class="btn ink-reaction btn-primary style-accent">Create</button>
						</div>
					</div>
				</div><!--end .card -->
