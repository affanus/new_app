...
class Engine_type extends Controller 
{
	...
	function __construct()
	{
		...
		$this->main_content_mange='admin/manage/engine_type/mange';
		$this->main_content_add='admin/manage/engine_type/add';
		$this->main_content_edit='admin/manage/engine_type/edit';
		$this->add_title='Add Engine Type';
		$this->edit_title='Edit Engine Type';
		$this->controler_name='engine_type';
		$this->tablename='engine_type';
	...
	{   
		$data['controler_name']=$this->controler_name;
		$data['query_aircraft_man']=$this->db->query("SELECT id,title From engine_man where isactive=1");
