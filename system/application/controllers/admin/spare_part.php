...
class Spare_part extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='Manage Spare Parts';
		$this->main_content_mange='admin/manage/spare_part/mange';
		$this->main_content_add='admin/manage/spare_part/add';
		$this->main_content_edit='admin/manage/spare_part/edit';
		$this->add_title='Add Spare Part';
		$this->edit_title='Edit Spare Part';
		$this->controler_name='spare_part';
	...
	function index($row=1)
	{
		...
		$data['query']=$this->db->query("SELECT id,title,p_number,nsn,isactive From ".$this->tablename);
