...
class Event_cat extends Controller 
{
	...
	function __construct()
	{
		...
		$this->main_content_mange='admin/manage/event_cat/mange';
		$this->main_content_add='admin/manage/event_cat/add';
		$this->main_content_edit='admin/manage/event_cat/edit';
		$this->add_title='Add Events Category';
		$this->edit_title='Edit Events Category';
		$this->controler_name='event_cat';
		$this->tablename='event_cat';
