...
class Apu_cat extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='APU Categories';
		$this->main_content_mange='admin/manage/apu_cat/mange';
		$this->main_content_add='admin/manage/apu_cat/add';
		$this->main_content_edit='admin/manage/apu_cat/edit';
		$this->add_title='Add APU Category';
		$this->edit_title='Edit APU Category';
		$this->controler_name='apu_cat';
		$this->tablename='apu_cat';
