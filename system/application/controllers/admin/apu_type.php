...
class Apu_type extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='APU Type';
		$this->main_content_mange='admin/manage/apu_type/mange';
		$this->main_content_add='admin/manage/apu_type/add';
		$this->main_content_edit='admin/manage/apu_type/edit';
		$this->add_title='Add APU Type';
		$this->edit_title='Edit APU Type';
		$this->controler_name='apu_type';
		$this->tablename='apu_type';
	...
	{   
		$data['controler_name']=$this->controler_name;
		$data['query_aircraft_man']=$this->db->query("SELECT id,title From apu_man where isactive=1");
