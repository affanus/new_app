...
class Air_cat extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='Aircraft Categories';
		$this->main_content_mange='admin/manage/air_cat/mange';
		$this->main_content_add='admin/manage/air_cat/add';
		$this->main_content_edit='admin/manage/air_cat/edit';
		$this->add_title='Add Aircraft Category';
		$this->edit_title='Edit Aircraft Category';
		$this->controler_name='air_cat';
		$this->tablename='aircraft_cat';
