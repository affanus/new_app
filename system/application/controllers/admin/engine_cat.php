...
class Engine_cat extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='Engine Categories';
		$this->main_content_mange='admin/manage/engine_cat/mange';
		$this->main_content_add='admin/manage/engine_cat/add';
		$this->main_content_edit='admin/manage/engine_cat/edit';
		$this->add_title='Add Engine Category';
		$this->edit_title='Edit Engine Category';
		$this->controler_name='engine_cat';
		$this->tablename='engine_cat';
