...
class Apu_man extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='APU Manufacturer';
		$this->main_content_mange='admin/manage/apu_man/mange';
		$this->main_content_add='admin/manage/apu_man/add';
		$this->main_content_edit='admin/manage/apu_man/edit';
		$this->add_title='Add APU Manufacturer';
		$this->edit_title='Edit APU Manufacturer';
		$this->controler_name='apu_man';
		$this->tablename='apu_man';
	...
	{   
		...
		$data['errormess'] = '';
		$data['query_air_cat']=$this->db->query("SELECT id,title From apu_cat");
	...
	{   
		...
		foreach ($_POST['air_cat'] as $air_cats):
			...
			$this->db->insert('apu_man_cat_link', $data2); 
		endforeach;
	...
	{   
		...
		$data['query_air_cat']=$this->db->query("SELECT id,title From apu_cat");
		$data['query_air_man_cat_link']=$this->db->query("SELECT * From apu_man_cat_link where man_id = '$editid'");
		$data['jsFilesArray'] =  array("libs/select2/select2.min.js");
	...
	{   
		...
		$data['errormess'] = '1';
		$data['query_air_cat']=$this->db->query("SELECT id,title From apu_cat");
		$data['query_air_man_cat_link']=$this->db->query("SELECT * From apu_man_cat_link");
		$data['main_content'] = $this->main_content_edit;
