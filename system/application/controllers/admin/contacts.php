...
class Contacts extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='Contacts';
		$this->main_content_mange='admin/users/contacts/manage';
		$this->main_content_add='admin/users/contacts/add';
		$this->main_content_edit='admin/users/contacts/edit';
	...
	function add_action(){
...

		{
			...
			$query=$this->db->query("SELECT id From users where email='".$this->input->post('useremail')."'");
			$row = $query->row();
			$user_id = $row->id;
			$data2 = array(
				'user_id' => $user_id ,
