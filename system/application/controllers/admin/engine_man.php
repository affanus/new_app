...
class Engine_man extends Controller 
{
	...
	function __construct()
	{
		...
		$this->title='Engine Manufacturer';
		$this->main_content_mange='admin/manage/engine_man/mange';
		$this->main_content_add='admin/manage/engine_man/add';
		$this->main_content_edit='admin/manage/engine_man/edit';
		$this->add_title='Add Engine Manufacturer';
		$this->edit_title='Edit Engine Manufacturer';
		$this->controler_name='engine_man';
		$this->tablename='engine_man';
	...
	{   
		...
		foreach ($_POST['air_cat'] as $air_cats):
			...
			$this->db->insert('engine_man_cat_link', $data2); 
		endforeach;
	...
	{   
		...
		$table = array('engine_man_cat_link');
	...
	{   
		...
		$data['query_air_cat']=$this->db->query("SELECT id,title From engine_cat");
		$data['query_air_man_cat_link']=$this->db->query("SELECT * From engine_man_cat_link where man_id = '$editid'");
		$data['jsFilesArray'] =  array("libs/select2/select2.min.js");
	...
	{   
		...
		$data['errormess'] = '1';
		$data['query_air_cat']=$this->db->query("SELECT id,title From engine_cat");
		$data['query_air_man_cat_link']=$this->db->query("SELECT * From engine_man_cat_link");
		$data['main_content'] = $this->main_content_edit;
