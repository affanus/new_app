...
class Mcqquestions extends Controller 
{
	...
	function __construct()
	{
		...
		$this->main_content_mange='admin/mange/mcqquestions/mange';
		$this->main_content_add='admin/mange/mcqquestions/add';
		$this->main_content_edit='admin/mange/mcqquestions/edit';
		$this->add_title='Add Questions';
		$this->edit_title='Edit Questions';
		$this->controler_name='mcqquestions';
		$this->tablename='mcqquestions';
	...
	{   
		...
		$data = array(
			...
			'isactive' => $this->input->post('isactive') ,
           	'opt1' => addslashes($this->input->post('opt1')),
			'opt2' => addslashes($this->input->post('opt2')),
			'opt3' => addslashes($this->input->post('opt3')),
			'opt4' => addslashes($this->input->post('opt4')),
			'pool'=> $this->input->post('pool'),
			'cat'=> $this->input->post('cat'),
			'right_ans'=> addslashes($this->input->post('right_ans'))
        );
