...
class News_cat extends Controller 
{
	...
	function __construct()
	{
		...
		$this->main_content_mange='admin/manage/news_cat/mange';
		$this->main_content_add='admin/manage/news_cat/add';
		$this->main_content_edit='admin/manage/news_cat/edit';
		$this->add_title='Add News Category';
		$this->edit_title='Edit News Category';
		$this->controler_name='news_cat';
		$this->tablename='news_cat';
